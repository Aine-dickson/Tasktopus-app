...
and exposed as \`req.me\`.)`
  ...
  fn: async function ({emailAddress, password, rememberMe}) {
    ...
    this.res.json({
      created: userRecord.createdAt, updated: userRecord.updatedAt,
      lasstSeen: userRecord.lastSeenAt, isAdmin: userRecord.isSuperAdmin,
      id: userRecord.id, name: userRecord.fullName, 
      email: userRecord.emailAddress, emailStatus: userRecord.emailStatus
    })
